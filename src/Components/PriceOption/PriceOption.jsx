...
const PriceOption = ({gymPrice}) => {
    ...
    return (
        <div className="bg-blue-400 text-center rounded-lg flex flex-col">
            <h1 className="text-5xl pt-4">{membership}</h1>
            ...
            <ol className="flex-grow">
               {
                features.map(feature => <li  className="text-2xl text-left ps-5 flex "><IoCaretForward className="mt-2"></IoCaretForward> {feature}</li>)
               }
            </ol>
